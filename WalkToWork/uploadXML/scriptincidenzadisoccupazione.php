...
$xmlDoc->load("incidenzadisoccupazione.xml");
$xpath = new DOMXPath($xmlDoc);
$hrefs = $xpath->evaluate("//anno");
$hrefs1 = $xpath->evaluate("//regione");

$hrefs2 = $xpath->evaluate("//percentuale_persone_in_cerca_di_occupazione");
...
for ($i=0;$i < $hrefs->length; $i++) {
    ...
    $sql = "INSERT INTO datasetdisoccupazione (anno, regione,percentualedisoccupazione)  VALUES('$url','$rest', '$url3')";
